 ...
 * 
 */
@WebServiceClient(name = "BanqueServiceService", targetNamespace = "http://service.adaming.fr/", wsdlLocation = "http://localhost:8585/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUESERVICESERVICE_QNAME = new QName("http://service.adaming.fr/", "BanqueServiceService");
    ...
    public BanqueWS getBanqueWSPort() {
        return super.getPort(new QName("http://service.adaming.fr/", "BanqueWSPort"), BanqueWS.class);
    }
    ...
    public BanqueWS getBanqueWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.adaming.fr/", "BanqueWSPort"), BanqueWS.class, features);
    }
